...
struct BridgeInterfaceConfig {
  ...
  std::vector<BridgeMemberConfig> member_configs; ///< Detailed member configurations
  std::optional<int> priority;              ///< Bridge priority (0-65535, default 32768)
  std::optional<int> hello_time;            ///< STP hello time in seconds (1-10, default 2)
  std::optional<int> forward_delay;         ///< STP forward delay in seconds (4-30, default 15)
  std::optional<int> max_age;               ///< STP max age in seconds (6-40, default 20)
  std::optional<int> aging_time;            ///< MAC address aging time in seconds (10-1000000)
  std::optional<int> max_addresses;         ///< Maximum number of MAC addresses in cache
};
